...
<body class="bg-[#280031]">
    <header class="w-full bg-[#3c1f42] flex justify-between items-center py-2 px-20">
        ...
        <div class="flex justify-center items-center">
            ...
            <label for="searchGame" class="cursor-pointer text-2xl p-2 rounded-full hover:bg-[#280031]">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" class="fill-current text-white">
            ...
            <div class="flex flex-wrap">
                <div class="flex gap-4 w-[600px] mt-5 mr-5">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <small>Hanya dibutuhkan beberapa detik saja untuk menyelesaikan pembayaran di Codashop karena situs kami berfungsi dengan baik dan mudah untuk digunakan.</small>
                    </div>
                </div>
                <div class="flex gap-4 w-[600px] mt-5 mr-5">
                ...
                <div class="flex gap-4 w-[600px] mt-5 mr-5">
                    ...
                    <div class="flex flex-col gap-2">
                        <b>Metode pembayaran terbaik</b>
                        <small>Kami menawarkan begitu banyak pilihan pembayaran mulai dari potong pulsa, e-wallet, bank transfer, dan pembayaran di mini market terdekat.</small>
                    </div>
                </div>
                <div class="flex gap-4 w-[600px] mt-5 mr-5">
                ...
                <div class="flex gap-4 w-[600px] mt-5 mr-5">
                    ...
                    <div class="flex flex-col gap-2">
                        <b>Promosi-promosi menarik</b>
                        <small>Penggemar game dapat bergantung pada Codashop karena kami memberikan penawaran menarik, diskon dan kode item dari promosi game yang disukai kamu.</small>
                    </div>
                </div>
                <div class="flex gap-4 w-[600px] mt-5 mr-5">
                    ...
                    <div class="flex flex-col gap-2">
                        <b>Dapatkan Lebih Banyak Keuntungan: Ikuti Program Referral Kami Sekarang!</b>
                        <small>Dapatkan hadiah dengan berbagi cinta! Undang teman dan dapatkan diskon 2500 IDR setelah temanmu melakukan pembelian pertama produk Topup! Kunjungi <a href="" class="underline text-[#e8f953]">FAQ</a> dan <a href="" class="underline text-[#e8f953]">S&K</a> kami untuk mempelajari lebih lanjut tentang program referral kami, dan mulailah dapatkan hadiah sekarang.</small>
                    </div>
                </div>
            </div>
        </section>
    ...
    <footer class="w-full h-fit">
        <div class="bg-[#e8f953] flex justify-between items-center p-20">
            ...
            <div class="flex gap-10">
                ...
                <div class="">
                    <p class="text-lg font-semibold mb-2">Area</p>
                    <a href="">
                        <div class="flex justify-center items-center gap-2 bg-black/25 p-2 rounded-lg">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/9/9f/Flag_of_Indonesia.svg" class="w-10 h-fit">
                            Indonesia
                        </div>
                    </a>
                </div>
        ...
        <div class="bg-[#eae8f7] flex justify-center p-3">
            <small>Hak Cipta © 2023 Raku Corp.</small>
        </div>
    </footer>
</body>
<script>
